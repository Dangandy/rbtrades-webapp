        ...
        <div className="hidden lg:flex lg:flex-shrink-0">
          <div className="flex flex-col w-64">
            ...
            <div className="flex flex-col flex-grow bg-green-700 pt-5 pb-4 overflow-y-auto">
              ...
              <nav
                className="mt-5 flex-1 flex flex-col divide-y divide-green-100 overflow-y-auto"
                aria-label="Sidebar"
              >
                <div className="px-2 space-y-1">
                  {navigation.map((item) => {
                  ...
                  <div className="px-2 space-y-1">
                    {secondaryNavigation.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
                        className="group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md text-green-100 hover:text-white hover:bg-green-600"
                      >
                        <item.icon
                          className="mr-4 h-6 w-6 text-green-200"
                          aria-hidden="true"
            ...
            <div className="flex-1 px-4 flex justify-between sm:px-6 lg:max-w-6xl lg:mx-auto lg:px-8">
              ...
              <div className="ml-4 flex items-center md:ml-6">
                ...
                <Menu as="div" className="ml-3 relative">
                  <div>
                    <Menu.Button className="max-w-xs bg-white rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 lg:p-2 lg:rounded-md lg:hover:bg-gray-50">
                      <img
